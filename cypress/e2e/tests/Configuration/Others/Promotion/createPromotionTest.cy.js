...
describe("Create Promotions Test", () => {
  ...
  it("Verify mandatory message is displayed", () => {
    ...
    onCreatePromotionPage
      ...
      .should("contain", "Promotion title is required");
    onCreatePromotionPage
      .getBUErrorMessage()
      .should("contain", "Business unit is required");
    onCreatePromotionPage
      .getBrandErrorMessage()
      .should("contain", "Brand is required");
    onCreatePromotionPage
      .getPromotionTypeErrorMessage()
      .should("contain", "Promotion type is required");
    onCreatePromotionPage
      .getPromotionConditionErrorMessage()
      .should("contain", "Condition is required");
    onCreatePromotionPage
      .getPromotionCriteriaErrorMessage()
      .should("contain", "Criteria is required");
    onCreatePromotionPage
      .getPromotionConditionValErrorMessage()
      .should("contain", "Value is required");

    onCreatePromotionPage
      .getPromotionDisbursementTypeErrorMessage()
      .should("contain", "Disbursement type is required");
    onCreatePromotionPage
  ...
  it.only("Verify user is redirected to list page on click of cancel button after entering data", () => {
    onPromotionsPage.clickCreateIcon();
    ...
    onCreatePromotionPage.enterValueFor(
      "Promotion Title",
      "Multiple sku promotion"
    );
    onCreatePromotionPage.enterValueFor(
      "Description",
      "Multiple sku promotion"
    ...
    // onCreatePromotionPage.selectStartDate("1");
    ...
    onCreatePromotionPage.selectPromotionCriteriaValue(
      ">= (GREATER THAN EQUALS)"
    );
  ...
  it("Verify char limit in title and description", () => {
    ...
    onCreatePromotionPage
      ...
      .should("have.text", "Create Promotions");
    onCreatePromotionPage.isSaveBtnDisplayed();
    onCreatePromotionPage.enterPromotionTitle(
      ""
    );
    onCreatePromotionPage.enterPromotionDescription(
      ""
    );

    onCreatePromotionPage
      .getTitleErrorMessage()
      .should("contain", "Promotion title must be atmost 255 characters long");
    onCreatePromotionPage
      .getDescErrorMessage()
      .should("contain", "Description must be atmost 255 characters long");
  });
  ...
  it("Verify user cannot Create Promotions having criteria and disbursement value as 0", () => {
    ...
    onCreatePromotionPage.clickOnDropdown("SKU");
    onCreatePromotionPage.selectSkuValue(
      "Sunfeast Good Day Butter Cookies 25+8 gm x 168 NPR 10 NP [9000031]"
    );
    ...
    onCreatePromotionPage.enterPromotionConditionValue(0.0);

    onCreatePromotionPage.clickOnDropdown("Disbursement Type");
    onCreatePromotionPage.selectPromotionDisbursement("Discount");

    onCreatePromotionPage.enterPromotionDisbursementValue(0.0);
  ...
  it.skip("verify Limit for value fields", () => {
    cy.get("@data1").then((data) => {
      data.forEach((promotion) => {
        ...
        cy.get(":nth-child(2) > :nth-child(1) > .form-input > .sc-idXgbr").type(
          title
        );

        cy.get(
          ":nth-child(2) > .single-date-picker > .sc-ipEyDJ > .datepicker-wrapper > .sc-kgTSHT > .filter-item > :nth-child(1) > :nth-child(1) > .date-input > .moment"
        ).click();
        ...
        cy.get(
          ":nth-child(2) > .config-panel-card > .config-panel-contents > .row > :nth-child(3) > .sc-ftTHYK > .form-select-input > .select-css > .zindex-2__control > .zindex-2__value-container > .zindex-2__input-container"
        ).click();
        ...
        cy.get(
          ":nth-child(3) > .config-panel-card > .config-panel-contents > .row > :nth-child(2) > .sc-ftTHYK > .form-select-input > .select-css > .zindex-2__control > .zindex-2__value-container"
        ).click();
        cy.selectDropdownValue(promotion.condition);

        cy.get(
          ":nth-child(3) > .config-panel-card > .config-panel-contents > .row > :nth-child(3) > .sc-ftTHYK > .form-select-input > .select-css > .zindex-2__control > .zindex-2__value-container"
        ).click();
        cy.selectDropdownValue(promotion.criteria);

        cy.get(":nth-child(4) > .form-input > .sc-idXgbr").type(
          promotion.criteriaValue
        );
        ...
        cy.get(":nth-child(2) > .form-input > .sc-idXgbr").type(
          promotion.disbursementValue
        );
        ...
        cy.get(":nth-child(1) > .text-center > .sc-gswNZR")
          .should("be.visible")
