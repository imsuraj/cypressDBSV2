...
describe('List Promotion Test', () => {
  ...
  it('Verify table header of promotion list page', () => {
    ...
    onPromotionsPage
      .getTableHeaderText(0)
      .should('have.attr', 'class', 'checkbox');
    onPromotionsPage.getTableHeaderText(1).should('have.text', 'ID');
    onPromotionsPage
      .getTableHeaderText(2)
      .should('have.text', 'Promotion Title');
    onPromotionsPage
      .getTableHeaderText(3)
      .should('have.text', 'Promotion Type');
    ...
    onPromotionsPage
      .getTableHeaderText(7)
      .find('span')
      .should('have.attr', 'class', 'sorting-icon');

    onPromotionsPage.isSearchIconDisplayed().should('be.visible');
    onPromotionsPage.isDateFilterIconDisplayed().should('be.visible');
    onPromotionsPage.isStandardFilterIconDisplayed().should('be.visible');
    onPromotionsPage.isCreateIconDisplayed().should('be.visible');
  });
  ...
  it('search promotion using title', () => {
    ...
    try {
      ...
      cy.log(
        'Promotion with the given title ' +
          promotionTitle +
  ...
  it('should display default list after clearing search', () => {
    ...
    onPromotionsPage.isSearchBoxDisplayed().should('not.exist');
  });
