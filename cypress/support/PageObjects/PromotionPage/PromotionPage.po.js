export class PromotionsPage {
  ...
  filterPlusIconEle = '.filter-btn.add > .kHoScB';
  ...
  isDateFilterIconDisplayed() {
    return cy.get(this.dateFilterEle);
  }

  isStandardFilterIconDisplayed() {
  ...
  clickOnPlusIconOfFilter() {
    cy.get(this.filterPlusIconEle).should('be.visible').click({ force: true });
  }
  ...
  clickThreeDotMenu() {
    cy.get(
      '.filter-item > :nth-child(1) > :nth-child(1) > .sc-jSUZER > .sc-eDvSVe'
    ).click({ force: true });
  }
