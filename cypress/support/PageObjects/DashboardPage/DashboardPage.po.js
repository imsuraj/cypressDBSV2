export class DashboardPage {
  ...
  accountingEntriesMenuEle =
    "ul:nth-child(1) > li:nth-child(8) > button:nth-child(1)";
  ...
  generalLedgerReportSubMenuEle =
    "li:nth-child(9) > ul > li:nth-child(5) > button";
  ledgerReportSubMenuEle =
    "a[href='/reports/general-ledger-reports/ledger-report']";
  cashBookSubMenuEle =
    "a[href='/reports/general-ledger-reports/ledger-cash-report']";
  customerReportSubMenuEle =
    "a[href='/reports/general-ledger-reports/ledger-customer-report']";
  ...
  updateSalesVatReportEle =
    'a[href="/reports/ird-reports/old-sales-vat-report"]';
  ...
  configurationMenuELe =
    "ul:nth-child(1) > li:nth-child(10) > button:nth-child(1)";
  otherSubMenuELe = "li:nth-child(10) > ul > li:nth-child(4) > button";
  promotionSubMenuEle = "a[href='/configuration/others/promotion']";
  ledgerMenuELe = "li:nth-child(10) > ul > li:nth-child(2) > button";
  catalogMenuELe = "li:nth-child(10) > ul > li:nth-child(1) > button";
  ...
  hoverMouseOverLedger() {
    cy.get(this.ledgerMenuELe).trigger("mouseover");
  }

  openCustomerLedgers() {
    cy.contains("Customer Ledgers").click();
  }
}
